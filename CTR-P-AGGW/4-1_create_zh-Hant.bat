...
REM MD build\cfa1
REM tools\3dstool -cvtf romfs build\cfa1\romfs.bin --romfs-dir cci\cfa1\romfs --romfs cci\cfa1\romfs.bin
REM MD build\cfa2
REM tools\3dstool -cvtf romfs build\cfa2\romfs.bin --romfs-dir cci\cfa2\romfs --romfs cci\cfa2\romfs.bin
REM MD build\cfa7
...
REM tools\3dstool -cvtf cfa build\1.cfa --header cci\cfa1\ncchheader.bin --romfs build\cfa1\romfs.bin
REM tools\3dstool -cvtf cfa build\2.cfa --header cci\cfa2\ncchheader.bin --romfs build\cfa2\romfs.bin
REM tools\3dstool -cvtf cfa build\7.cfa --header cci\cfa7\ncchheader.bin --romfs build\cfa7\romfs.bin
REM tools\3dstool -cvt0127f cci build\0.cxi build\1.cfa build\2.cfa build\7.cfa "Luigi's Mansion 2 (TWN) (zh-Hant).3ds" --header cci\ncsdheader.bin
tools\3dstool -cvt0127f cci build\0.cxi cci\1.cfa cci\2.cfa cci\7.cfa "Luigi's Mansion 2 (TWN) (zh-Hant).3ds" --header cci\ncsdheader.bin
IF NOT "%~1"=="" (
tools\3dstool --diff -vt cci --old "%~1" --new "Luigi's Mansion 2 (TWN) (zh-Hant).3ds" --patch-file patch.3ps
tools\icn2ico cci\cxi0\exefs\icon.icn zh\icon.ico
CALL make_3ps_exe.bat zh\icon.ico patch.3ps zh-Hant_AGGWTOOLS || CALL ..\exepatch\make_3ps_exe.bat zh\icon.ico patch.3ps zh-Hant_AGGWTOOLS
DEL zh\icon.ico
)
POPD
