...
MD build\cfa2
tools\3dstool -cvtf romfs build\cfa2\romfs.bin --romfs-dir cci\cfa2\romfs --romfs cci\cfa2\romfs.bin
MD build\cfa7
...
tools\3dstool -cvtf cfa build\2.cfa --header cci\cfa2\ncchheader.bin --romfs build\cfa2\romfs.bin
tools\3dstool -cvtf cfa build\7.cfa --header cci\cfa7\ncchheader.bin --romfs build\cfa7\romfs.bin
tools\3dstool -cvt0127f cci build\0.cxi build\1.cfa build\2.cfa build\7.cfa "Luigi's Mansion 2 (TWN) (zh-Hant).3ds" --header cci\ncsdheader.bin
IF NOT "%~1"=="" (
