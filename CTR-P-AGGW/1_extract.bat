...
RD /S /Q cci
MD cci
tools\3dstool -xvt0127f cci cci\0.cxi cci\1.cfa cci\2.cfa cci\7.cfa "%~1" --header cci\ncsdheader.bin
MD cci\cxi0
...
REM DEL cci\1.cfa
REM MD cci\cfa2
REM tools\3dstool -xvtf cfa cci\2.cfa --header cci\cfa2\ncchheader.bin --romfs cci\cfa2\romfs.bin
REM DEL cci\2.cfa
REM MD cci\cfa7
...
REM tools\3dstool -xvtf romfs cci\cfa2\romfs.bin --romfs-dir cci\cfa2\romfs
